...
public:
    ...
    void
    insertNode(int value, std::string n_date, int n_rank, std::string n_song, std::string n_artist, int n_last_week,
               int n_peak_rank, int n_weeks_on_board, nodeClass *treeRoot);
